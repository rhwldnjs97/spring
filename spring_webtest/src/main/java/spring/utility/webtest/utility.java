	...
	/** 
	 ...
	 public static String paging(int totalRecord, int nowPage, int recordPerPage, String col, String word){ 
	   ...
	   return str.toString(); 
		...
		public static String rpaging(int totalRecord, int nowPage, int recordPerPage, String col, String word, int nPage, String url, int bbsno) {
			int pagePerBlock = 10; // 블럭당 페이지 수 
			   int totalPage = (int)(Math.ceil((double)totalRecord/recordPerPage)); // 전체 페이지  
			   int totalGrp = (int)(Math.ceil((double)totalPage/pagePerBlock));// 전체 그룹 
...
//			     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
			   ...
			   if (nowGrp >= 2){ 
			     str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&bbsno=" + bbsno + "&nPage=" + nPage + "&word="+word+"&nowPage="+nowPage+"'>이전</A></span>"); 
			   } 
			   ...
			   for(int i=startPage; i<=endPage; i++){ 
			     ...
			     if (nPage == i){ 
			       ...
			       str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&bbsno=" + bbsno + "&nPage=" + i + "&word="+word+"&nowPage="+nowPage+"'>"+i+"</A></span>");   
			     } 
			   } 
			    
			   _nPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
			   if (nowGrp < totalGrp){ 
			     str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&bbsno=" + bbsno + "&nPage=" + _nPage +"&word="+word+"&nowPage="+nowPage+"'>다음</A></span>"); 
			   } 
			   str.append("</DIV>"); 
		...
		public static String bpaging(int totalRecord, int nowPage, int recordPerPage, String col, String word, int nPage, String url, int num) {
			int pagePerBlock = 10; // 블럭당 페이지 수 
			   int totalPage = (int)(Math.ceil((double)totalRecord/recordPerPage)); // 전체 페이지  
			   int totalGrp = (int)(Math.ceil((double)totalPage/pagePerBlock));// 전체 그룹 
			   int nowGrp = (int)(Math.ceil((double)nPage/pagePerBlock));    // 현재 그룹 
...
//			     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
			   ...
			   int _nPage = (nowGrp-1) * pagePerBlock; // 10개 이전 페이지로 이동 
			   if (nowGrp >= 2){ 
			     str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&num=" + num + "&nPage=" + nPage + "&word="+word+"&nowPage="+nowPage+"'>이전</A></span>"); 
			   } 
			   ...
			   for(int i=startPage; i<=endPage; i++){ 
			     ...
			     if (nPage == i){ 
			       ...
			       str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&num=" + num+ "&nPage=" + i + "&word="+word+"&nowPage="+nowPage+"'>"+i+"</A></span>");   
			     } 
			   } 
			    
			   _nPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
			   if (nowGrp < totalGrp){ 
			     str.append("<span class='span_box_1'><A href='./"+url+"?col="+col+ "&num=" + num+ "&nPage=" + _nPage +"&word="+word+"&nowPage="+nowPage+"'>다음</A></span>"); 
			   } 
			   str.append("</DIV>"); 
