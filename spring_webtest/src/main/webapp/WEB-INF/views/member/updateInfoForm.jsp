...
<body>
	...
	<FORM name='frm' method='POST' action='./update'
		...
		<DIV class="container">
			<h2>${dto.mname }의 회원정보 수정
			</h2>

			<TABLE class="table">
				<TR>
					<TD colspan="2" style="text-align: center"><img
						src="../member/storage/${dto.fname }"></TD>
				</TR>
				<TR>
					<TH>아이디</TH>
					<TD>${dto.id }</TD>
				...
				<TR>
					...
					<TD><input type="text" name="email" size="15"
						...
						value="Email중복확인" onclick="emailCheck(document.frm.email.value)"></TD>
				</TR>
				<TR>
					<TH>우편번호</TH>
					<TD><input type="text" name="zipcode" size="7"
						id="sample6_postcode" value="${dto.zipcode }"> <input
						type="button" value="우편번호찾기" onclick="sample6_execDaumPostcode()"></TD>
				</TR>
				<TR>
					<TH>주소</TH>
					<TD><input type="text" name="address1" size="40"
						id="sample6_address" value="${dto.address1 }"> <input
						type="text" name="address2" size="40" id="sample6_address2"
